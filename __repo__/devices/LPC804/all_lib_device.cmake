...
list(APPEND CMAKE_MODULE_PATH
  ...
  ${CMAKE_CURRENT_LIST_DIR}/../../boards/lpcxpresso804/project_template
...
include_if_use(component_at_least_one_i2c_mux_device_enabled.LPC804)
include_if_use(component_button.LPC804)
include_if_use(component_common_task)
include_if_use(component_ctimer_adapter.LPC804)
include_if_use(component_enable_pca9544.LPC804)
include_if_use(component_enable_pca9548.LPC804)
include_if_use(component_flash_adapter.LPC804)
include_if_use(component_i2c_adapter_interface.LPC804)
include_if_use(component_i2c_mux_pca954x.LPC804)
include_if_use(component_lists.LPC804)
include_if_use(component_lpc_crc_adapter.LPC804)
include_if_use(component_lpc_i2c_adapter.LPC804)
include_if_use(component_mcxw_flash_adapter.LPC804)
include_if_use(component_mem_manager.LPC804)
include_if_use(component_mem_manager_legacy.LPC804)
include_if_use(component_mem_manager_light.LPC804)
include_if_use(component_miniusart_adapter.LPC804)
include_if_use(component_mrt_adapter.LPC804)
include_if_use(component_osa)
include_if_use(component_osa_bm)
include_if_use(component_osa_template_config)
include_if_use(component_panic.LPC804)
include_if_use(component_pwm_ctimer_adapter.LPC804)
include_if_use(component_reset_adapter.LPC804)
include_if_use(component_rng_adapter_interface.LPC804)
include_if_use(component_rnga_adapter.LPC804)
include_if_use(component_rt_gpio_adapter.LPC804)
include_if_use(component_software_crc_adapter.LPC804)
include_if_use(component_software_rng_adapter.LPC804)
include_if_use(component_timer_manager.LPC804)
include_if_use(device_CMSIS.LPC804)
include_if_use(device_RTE.LPC804)
include_if_use(device_project_template.LPC804)
include_if_use(device_startup.LPC804)
include_if_use(device_system.LPC804)
include_if_use(driver_capt.LPC804)
include_if_use(driver_clock.LPC804)
include_if_use(driver_common.LPC804)
include_if_use(driver_ctimer.LPC804)
include_if_use(driver_iap.LPC804)
include_if_use(driver_lpc_acomp.LPC804)
include_if_use(driver_lpc_adc.LPC804)
include_if_use(driver_lpc_crc.LPC804)
include_if_use(driver_lpc_dac.LPC804)
include_if_use(driver_lpc_gpio.LPC804)
include_if_use(driver_lpc_i2c.LPC804)
include_if_use(driver_lpc_iocon_lite.LPC804)
include_if_use(driver_lpc_minispi.LPC804)
include_if_use(driver_lpc_miniusart.LPC804)
include_if_use(driver_mrt.LPC804)
include_if_use(driver_pint.LPC804)
include_if_use(driver_plu.LPC804)
include_if_use(driver_power.LPC804)
include_if_use(driver_reset.LPC804)
include_if_use(driver_romapi.LPC804)
include_if_use(driver_swm.LPC804)
include_if_use(driver_swm_connections.LPC804)
include_if_use(driver_syscon.LPC804)
include_if_use(driver_syscon_connections.LPC804)
include_if_use(driver_wkt.LPC804)
include_if_use(driver_wwdt.LPC804)
...
include_if_use(utilities_misc_utilities.LPC804)
include_if_use(utility_assert_lite.LPC804)
include_if_use(utility_debug_console_lite.LPC804)
include_if_use(utility_incbin.LPC804)
include_if_use(utility_str.LPC804)
