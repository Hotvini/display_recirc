...
#define BOARD_BOOTCLOCKRUN_CAPT_CLOCK                 15000000UL     /* Clock consumers of CAPT_clock output : CAPT */
...
#define BOARD_BOOTCLOCKRUN_UART0_CLOCK                15000000UL     /* Clock consumers of UART0_clock output : USART0 */
