...
outputs:
- {id: CAPT_clock.outFreq, value: 15 MHz}
...
settings:
- {id: SYSCON.CAPTCLKSEL.sel, value: SYSCON.MAINCLKSEL}
- {id: SYSCON.UART0CLKSEL.sel, value: SYSCON.MAINCLKSEL}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS **********/
...
void BOARD_BootClockRUN(void)
{
    ...
    CLOCK_Select(kCAPT_Clk_From_Fro);                   /*!< select FRO clk for CAPT */
